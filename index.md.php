...
<body  text="#ff69b4"> 
	...
	<input type="button" value="已使用過"   style="width:120px;height:40px; border:2px #ffc0cb double; background-color:#ffe4e1;" onclick="location.href= ('http://mebabybaby07.github.io./login.html')">
</body>
